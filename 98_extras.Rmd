...
moran.test(listings$price, listw = nb2listw(neigh_4))

moran.mc(listings$price, listw = nb2listw(neigh_4), nsim = 999)

moran.plot(listings$price, listw = nb2listw(neigh_4))

lm <- localmoran(listings$price, listw = nb2listw(neigh_4))
...
listings$price_lag <- lag.listw(nb2listw(neigh_4), listings$price_std)
...
listings@data[(listings$price_std <= 0 & listings$price_lag >= 0) & (lm[, 5] <= 0.05), "quad_sig"] <- 5  

frq(listings$quad_sig)
