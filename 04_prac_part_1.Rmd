...
Navigate to course [website](https://github.com/RPanczak/ReduSpatial) and download course materials

![](./images/download.PNG)

Extract the `ReduSpatial-master.zip` file. You should have `ReduSpatial-master` folder with multiple `html`, `Rmd` and `md` files inside.   

## Start your project 

1. Open Rstudio.
2. Create a project (**inside the `ReduSpatial-master` folder that you downloaded**).
3. Create a new R markdown document (recommended) or R script.
