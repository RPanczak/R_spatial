...
1. Open Rstudio
2. Create a project (**inside the folder that you downloaded**)
...
2. Examine relationships between two different indices for Autralia. What kind of graphs and statistics could be useful here?
